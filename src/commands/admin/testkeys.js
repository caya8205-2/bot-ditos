...
module.exports = {
    ...
    async execute(message) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setColor('#4CAF50')
            .setDescription('KoboldCpp menjadi provider utama, lalu Niner, lalu Groq sebagai fallback terakhir.')
            .addFields(
                ...
                { name: 'Model Niner', value: `\`${NINER_MODEL}\``, inline: true },
                { name: 'Niner tersedia', value: status.secondary.available ? 'Ya' : 'Tidak', inline: true },
                { name: 'Niner cooldown', value: status.secondary.onCooldown ? 'Ya' : 'Tidak', inline: true },
                ...
                { name: 'Cooldown Niner', value: `${NINER_FALLBACK_COOLDOWN_MS} ms`, inline: true },
